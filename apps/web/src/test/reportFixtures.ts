  ...
  records: [
    {
      ...
      proceeds: zeroFact,
      profit: missingFact,
      total_assets: { ...missingFact, key: 'total_assets' },
      equity: { ...missingFact, key: 'equity' },
      cash: { ...missingFact, key: 'cash' },
      receivables: { ...missingFact, key: 'receivables' },
      accounts_payable: { ...missingFact, key: 'accounts_payable' },
      additional_facts: [],
      evidence_refs: [`report:${REPORT_ID}:/finReports/0`],
    },
  ],
  facts: [],
