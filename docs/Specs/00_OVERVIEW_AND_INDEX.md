...
Визуальный результат реализации показан скриншотами в корневом
[`README.md`](../../README.md); исходные дизайнерские материалы не входят в
законсервированную версию репозитория.
