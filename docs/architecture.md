...
[`Specs/10_SYSTEM_CONTRACTS.md`](Specs/10_SYSTEM_CONTRACTS.md). Этот файл
намеренно остаётся коротким, чтобы не создавать вторую расходящуюся архитектуру.
...
Изменения границ сервисов, владения данными или обязательного стека отражаются
в Specs; история реализации сохраняется в Git.
