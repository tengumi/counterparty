...
REFERENCE: tuple[KnowledgeEntry, ...] = (
    ...
    KnowledgeEntry(
        ...
        statement=(
            "Банковский светофор — цветовой индикатор скоринга банка на момент "
            "проверки; методика внутренняя и не раскрывается. Зелёный — надёжный "
            "контрагент, жёлтый — требует внимания, красный — в зоне риска, серый — "
            "нет данных для оценки. Это не оценка финансов: зелёный бывает и при "
            "отрицательном капитале."
        ),
        examples=(
            KnowledgeExample(
                signal="Светофор зелёный, капитал по последнему периоду отрицательный.",
                correct="Назвать светофор надёжным по методике банка и отдельно "
                "отметить отрицательный капитал как финансовый сигнал.",
    ...
    KnowledgeEntry(
        ...
        statement=(
            "Оценка ЗСК (платформа Банка России «Знай своего клиента») и банковский "
            "светофор — разные сигналы. ЗСК показывает уровень риска подозрительных "
            "операций — низкий, средний или высокий; высокий уровень означает, что "
            "работать с контрагентом небезопасно по антиотмывочному законодательству. "
            "Значение справочное, методику ЗСК не пересчитываем и не объясняем, в один "
            "уровень риска с банковским светофором не сводим."
        ),
        examples=(
            KnowledgeExample(
                signal="ЗСК высокий, банковский светофор зелёный.",
                correct="Показать высокий ЗСК отдельно как сигнал по антиотмывочному "
                "законодательству и не смешивать его с банковской оценкой.",
                incorrect="Свести ЗСК и светофор к одному «уровню риска» или "
                "проигнорировать высокий ЗСК из-за зелёного светофора.",
            ),
        ),
    ),
    KnowledgeEntry(
